...
class InformeFinalController extends Controller
{
  ...
  public function show(string $id)
  {
    ...
    try {
      ...
      $infoFinancieras = DB::select("select pif.tiene_prestamo, pif.monto_prestamo, pif.entidad_bancaria_prestamo_id as entidad_prestamo, pif.cuota_mensual_prestamo, pif.otro_ingreso, pif.monto_ingreso, pif.origen_ingreso, pif.tiene_propiedades, pif.detalle_propiedades, pif.reportado_centrar_riesgos, eb2.entidad_bancaria_reporto_id as entidad_reporto, pif.motivo_reportado, pif.tiempo_mora, pif.monto_deuda from personas_informaciones_financieras pif where persona_id = ?", [$persona->id])[0];

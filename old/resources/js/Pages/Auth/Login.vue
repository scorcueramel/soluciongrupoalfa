...
<!--                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Grupo Alfa</div>-->
<!--                        <span class="text-muted-color font-medium">Bienvenido, Inicia sesión para comenzar</span>-->
                    </div>
...
<!--                                <span class="font-medium no-underline ml-2 text-right cursor-pointer text-[#B00202]">Olvido su contraseña?</span>-->
                            </div>
                            <button type="submit" class="w-full bg-[#B00202] text-white p-2 rounded-md hover:bg-[#BC2727]">Iniciar Sesion</button>
                        </div>
                    </form>
                </div>
            </div>

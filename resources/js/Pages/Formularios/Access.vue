            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, #FF0000 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="flex justify-center mb-4">
                        <img src="/demo/images/logo.png" alt="logo-grupo-alfa">
                    </div>
                    <div class="flex justify-center mb-12">
                        <span class="text-muted-color font-medium text-xl text-center">Ingresa tu número de documento para continuar</span>
                    </div>
